        ...
        <section className="py-10 bg-gray-100 sm:py-16 lg:py-24">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="max-w-2xl mx-auto text-left sm:text-center">
                    <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">{RichText.asText(primary.newsletter_section_title)}</h2>
                    <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-600">{primary.headline_text}</p>
                </div>
                        ...
                        items.map((id)=> {
                            return (
                                <div className="flex items-start">
                                    <svg className="flex-shrink-0 text-yellow-400 w-7 h-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                    </svg>
                                    <div className="ml-4">
                                        <h3 className="text-xl font-semibold text-black">{id.feature_name}</h3>
                                        <p className="mt-1.5 text-base text-gray-600">{id.feature_description}</p>
                                    </div>
                                </div>
                            )})
                    }
                            ...
                            <div className="flex-1 w-full min-w-0">
                                <div className="relative text-gray-400 focus-within:text-gray-600">
                                    ...
                                    <input
                                        ...
                                        name="email"
                                        id="email"
                                        placeholder={primary.input_label}
                                        className="block w-full py-4 pl-10 pr-4 text-base text-black placeholder-gray-500 transition-all duration-200 border-transparent rounded-full focus:outline-none caret-blue-600"
                                        required=""
                                    />
                                </div>
                            </div>
                ...
                <div className="flex items-center justify-start mt-8 sm:justify-center sm:px-0">
                    ...
                    <span className="ml-2 text-sm text-gray-600">{primary.terms_description}</span>
                </div>
            </div>
        </section>
    )
